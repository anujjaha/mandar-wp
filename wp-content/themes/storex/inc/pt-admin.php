...
$on_off_author_bio_option = OptionFactory::create('on-off-author-bio_id',
	'on-off-author-bio',
	FieldType::$ONOFF,
	'pt-global',
	'Disable author biography ?',
		array(
		'default' => 'on',
		'description' => 'If "ON" author biography appears on single post page'
	),
false);
...
/*  Store Settings  */
$storex_catalog_mode_option = OptionFactory::create('storex_catalog_mode_option_id',
		'catalog_mode',
		FieldType::$ONOFF,
		'pt-store',
		'Catalog Mode view switcher',
			array(
				'default' => 'off',
...
$show_upsells_products_option = OptionFactory::create('show_upsells_products_id',
'show_upsells_products',
FieldType::$ONOFF,
'pt-store',
'Single product upsells products output switcher',
array(
'default' => 'on',
'description' => ''
),
