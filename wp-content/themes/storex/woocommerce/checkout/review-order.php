...
<table class="shop_table woocommerce-checkout-review-order-table">
	<!--<thead>
		<tr>
			<th class="product-name"><?php// esc_html_e( 'Product', 'storex' ); ?></th>
			<th class="product-total"><?php// esc_html_e( 'Total', 'storex' ); ?></th>
		</tr>
	</thead>-->
	<tbody>
		<?php
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			<th><?php esc_html_e( 'Cart Subtotal', 'storex' ); ?></th>
		...
		<tr class="order-total">
			<th><?php esc_html_e( 'Order Total', 'storex' ); ?></th>
